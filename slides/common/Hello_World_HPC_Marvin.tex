...
#SBATCH -A tmp_snakemake_workshop
#SBATCH -p intelsr_devel
#SBATCH -t 10
# only necessary during this course
#SBATCH -q snakemake_workflow
#SBATCH --reservation snakemake_workflow
