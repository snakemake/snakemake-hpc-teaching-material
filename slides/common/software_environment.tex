	...
	\frame{
		...
		\begin{mdframed}[tikzsetting={draw=white,fill=white,fill opacity=0.8,
			...
			\begin{itemize}
				...
				\item pixi - different to Conda - will be supported \Snakemake soon.
			\end{itemize}
		\end{mdframed}
	}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\begin{frame}[fragile]
	\frametitle{The \texttt{Marvin} Approach}
	You \emph{could} run
	\begin{lstlisting}[language=Bash, style=Shell, basicstyle=\tiny,breaklines=true ]
$ wget https://github.com/conda-forge/miniforge/releases/latest/download/Miniforge3-Linux-x86_64.sh
$ bash Miniforge3-Linux-x86_64.sh
	\end{lstlisting}
     However, on Marvin, please refrain from installing Conda yourself, run:
     \begin{lstlisting}[language=Bash, style=Shell,breaklines=true ]
$ module load Miniforge
$ conda init       # only once
$ source ~/.bashrc # only once
     \end{lstlisting}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{lstlisting}[language=Bash, style=Shell]
$ conda activate <++course.softwarepath++>
	\end{lstlisting}
...
\begin{frame}[fragile]
    ...
    \begin{lstlisting}[language=Bash, style=Shell]
$ (software_stack) conda list | grep snakemake
    \end{lstlisting}
     And you should see
