...
@}@
      \end{lstlisting}
      {\footnotesize \bcattention Add the highlighted lines and your login will be faster! Also, this allows to separate the module environment and conda-related environments safely.}
    \end{column}
  \end{columns}
\end{frame}
