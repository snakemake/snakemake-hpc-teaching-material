...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\begin{frame}[fragile]
	\frametitle{Creating an Environment from Scratch}
	You can create the same environment using this command:
	\begin{lstlisting}[language=Bash, style=Shell]
$ mamba create \
> -c conda-forge -c bioconda \
> -n snakemake \
...
> snakemake-storage-plugin-fs
    ...
    \pause
    \begin{docs}[Note:]
    	Installing a Conda package which has dependencies,\newline e.\,g. \verb+snakemake snakemake-executor-plugin-slurm+\linebreak which needs \Snakemake{}, will install all dependencies in the same environment.
    \end{docs}
\end{frame}
...
\begin{frame}[fragile]
    ...
    \begin{lstlisting}[language=Bash, style=Shell]
$ (snakemake) mamba list | grep snakemake
    \end{lstlisting}
     And you should see
