...
{   
	\usebackgroundtemplate{
		\vbox to \paperheight{\vfil\hbox to \paperwidth{\hfil\includegraphics[height=0.7\paperheight]{logos/reproducibility.jpg}\hfil}\vfil}
		% https://the-turing-way.netlify.app/_images/reproducibility.jpg
		
	}
	\frame{
		\frametitle{How to contribute back}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{Is it \Snakemake, the Workflow or the Cluster?}
  	\begin{columns}[t]
...
\begin{frame}
	...
	\begin{question}[Where?]
		The issue tracker at your workflow. For \Snakemake{} somewhere in the \lhref{https://snakemake.github.io/snakemake-workflow-catalog/}{catalog}. 
	\end{question}
	\pause
	\begin{question}[What?]
...
\begin{frame}
  ...
  \begin{question}[Where?]
  	 The \lhref{https://github.com/snakemake/snakemake/issues}{issue tracker of the \Snakemake{} project}.
  \end{question}	
  \pause
  \begin{question}[What?]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\frametitle{Reporting Glitches in THESE Slides}
	After each course you will receive all slides and scripts. You will have noticed: This is complex material! Of course, there will be errors. We appreciate, if you report your finding on our \lhref{https://github.com/snakemake/snakemake-hpc-teaching-material/}{project web site}.\newline
	Any other feedback, i.\,e. ideas, suggestions etc. is welcomed!
	\begin{hint}
		For all these little contributions, for your data analysis, for your scientific work -- you have to learn git.
		\begin{itemize}
			\item Here is an \lhref{https://github.com/skills/introduction-to-github}{introduction from GitHub for GitHub newbies}.
			\item Your local site might have introductory courses for a GitLab instance or similar git services.
		\end{itemize}
	\end{hint}
\end{frame}	
