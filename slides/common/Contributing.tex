...
\begin{frame}
  ...
  \begin{block}{Open Source is \emph{NOT JUST} about Programming}
  	\lhref{https://opensource.guide/how-to-contribute/}{You can}
  	\begin{itemize}[<+->]
...
\begin{frame}
  ...
  \pause
  \begin{hint}
  	It is important to figure out the underlying issue before reporting anything!
  \end{hint}	
\end{frame}
...
\begin{frame}
  ...
  If you want to report an issue or even contribute back to the project with anything else, you will need an account. \lhref{This page}{https://docs.github.com/en/get-started/onboarding/getting-started-with-your-github-account} describe how. 
\end{frame}
...
\begin{frame}
    ...
    \pause
    \begin{question}[How?]
      Give a meaningful brief statement. "I cannot to \altverb{ls} on \altverb{/some/path}." is more meaningful than "The filesystem stopped working!" and "For me too!" messages.\newline
