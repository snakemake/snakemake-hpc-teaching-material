...
\setbeamertemplate{frametitle}{%
  \nointerlineskip%
  \begin{beamercolorbox}[wd=\paperwidth,ht=2.6ex,dp=1.1ex,leftskip=0.3cm,rightskip=0.3cm plus1fil]{frametitle}%
    \usebeamerfont{frametitle}\insertframetitle%
    \hfill\raisebox{-0.15ex}{\includegraphics[height=1.7ex]{<++layout.logo++>}}%
  \end{beamercolorbox}%
}
<+++endif+++>
...
\hypersetup{
  ...
  linkcolor=,
  urlcolor=links,
  <+++ if course.pdftitle is defined and course.pdftitle +++>
