...
%% PLEASE NOTE %%
%%%%%%%%%%%%%%%%%
% Multiple frames containing ``Hand Out'' or ``Interlude'' should be started:
...
% respectively. Single frames may just start with
...
\title[Introduction to Workflow Programming]{An Introduction to HPC-conformant Scientific Workflows with \Snakemake} 
