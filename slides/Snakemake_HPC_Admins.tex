...
\hypersetup{colorlinks,linkcolor=,urlcolor=links, pdftitle = {Importance of Snakemake Workflows for Admins and HPC-Users}, pdfauthor = {<++instructor.name++>}, pdfsubject = {<++course.title++>}, pdfkeywords = {<++course.keywords++>}}

\title[<++course.shorttitle++>]{<+++ if course.title is defined +++><++course.title++><+++else+++>Importance of \Snakemake Workflows for Admins and HPC-Users<+++endif+++>} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{<++course.cluster_profile++>}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{admin/software_environment}
      
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{admin/Datamanagement}
