...
\subtitle{Workflow Course - Edition 3} %TODO: Is there a way to retrieve this from the command line?
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ifbool{generic}
       {\include{generic/Python_in_Snakemake}}
       {\include{lifescience/Python_in_Snakemake}}
       
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ifbool{generic}
       {\include{generic/Finishing_and_Execution}}
       {\include{lifescience/Finishing_and_Execution}}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ifbool{generic}
       {\include{generic/Plotting_DAGs}}
       {\include{lifescience/Plotting_DAGs}}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%TODO: move content into A First Workflow
\ifbool{generic}{\include{First_Wildcards}}{}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ifbool{generic}
      {\include{generic/Decorating_the_Workflow}}
      {\include{lifescience/Decorating_the_Workflow}}
