...
\begin{frame}[fragile]
  ...
  Now, on HPC-systems scientific software is a provided as module files and provisioned by ``build frameworks'' like \texttt{easybuild} or \texttt{spack}. With \texttt{snakemake} we are going to \texttt{Conda}. Why? Some pros and cons:
  \begin{itemize}[<+->]
...
\begin{frame}[fragile]
  ...
  \begin{lstlisting}[language=Bash, style=Shell] 
$ python zipf_analysis/scripts/plotcount.py -i isles.dat --type ascii
  \end{lstlisting}
  \pause
