...
$ mamba create -n <name of new env> --clone snakemake
    ...
    \pause
    \begin{task}
    	Pick one workflow from the catalogue, create a new environment with a corresponding name, e.\,g. \altverb{rna-seq-star}. Activate it. Then, run \altverb{mamba install snakedeploy}.
    \end{task}    
\end{frame}
