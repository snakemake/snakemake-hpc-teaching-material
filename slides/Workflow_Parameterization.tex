...
input_path = config["path"]
  \end{lstlisting}
  \hint{We know, is useless: if our \texttt{path} is a relative path, every derived path is relative to our current working directory!}
  \pause
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]
  \frametitle{Our \emph{FINAL} Workflow}
  You may copy this solution.
  \begin{lstlisting}[language=Python,style=Python]
import os
