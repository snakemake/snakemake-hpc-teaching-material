...
rule count_words:
  ...
  This is a build file, which for Snakemake is called a Snakefile — a file executed by Snakemake. Note that aside from a few keyword additions like \altverb{rule}, it follows standard Python 3 syntax.
