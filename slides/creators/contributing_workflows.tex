...
\begin{frame}
	\frametitle{Remember the Catalog!}
		The \lhref{https://snakemake.github.io/snakemake-workflow-catalog/?rules=true}{\Snakemake{} workflow cataloge} has a plethora of workflows to offer!\newline
	...
	\begin{adjustbox}{max totalsize={.9\textwidth}{.7\textheight},center}
		...
		\begin{tikzpicture}[scale=0.8, auto, every node/.style={font=\footnotesize, >=stealth}]
			...
			\node[below of=solutions, text width=8cm,font=\normalsize, yshift=-1.5cm] {\begin{question}[How to search?]
					Search in the Snakemake Workflow Catalog!
			\end{question}};
			%\onslide<1->	
		\end{tikzpicture}
