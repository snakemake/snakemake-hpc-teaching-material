...
\begin{frame}
  ...
  \hint[Note]{For now we will not use \texttt{snakemake} to install our software. This topic will be covered later.}
\end{frame}
...
%  Here, we are using
%  \begin{itemize}
%    \item \altverb{-f environment.yaml} - our downloaded software definition file
%    \item \altverb{--pyc} - a flag to "compile" Python source code to byte code (Python would do this anyway, but why whait?)
%  \end{itemize}
%\end{frame}		
%
%\begin{frame}[fragile]
