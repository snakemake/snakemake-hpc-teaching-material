%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Why use Workflow Managers?}
{   
	\usebackgroundtemplate{
		\vbox to \paperheight{\vfil\hbox to \paperwidth{\hfill\includegraphics[height=\paperheight]{humor/geograaf_vermeer}}\vfil}
	}
	\frame{
		\frametitle{Charting new(?) territory -- Workflow Management Systems on HPC clusters}
		\begin{mdframed}[tikzsetting={draw=white,fill=white,fill opacity=0.8,
				line width=0pt},backgroundcolor=none,leftmargin=0,
			rightmargin=150,innertopmargin=4pt,roundcorner=10pt]
			\tableofcontents[currentsection,sections={1-4},hideothersubsections]
		\end{mdframed}
		\vspace{12mm}\hfill{\tiny \color{white}"De Geograaf" by Dutch painter Johannes Vermeer, 1668-1669, \lhref{https://nl.wikipedia.org/wiki/De_geograaf}{wikipedia}}}
	}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{
	\colorlet{links}{white}
	\usebackgroundtemplate{
		\vbox to \paperheight{\vskip 0.6cm\hbox to \paperwidth{\hfil\includegraphics[width=\paperwidth]{humor/Marie-Antoinette-callout.jpeg}\hfil}\vfil}
	}
	\begin{frame}
		\frametitle{What kind of Support do you want to deliver?}
		\vfill\vspace*{9em}
		\hfill{\footnotesize\color{white} image: Marie Antoinettes, by Jean-Baptiste-André Gautier-Dagoty, ca. 1775 - \lhref{https://fr.wikipedia.org/wiki/Marie-Antoinette_d\%27Autriche}{wikipedia}}
	\end{frame}
}
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			  \pause
			\begin{question}
				How portable is this? How maintainable? How many HPC users are able to accomplish this?\\\pause\vspace{0.5em}
...
{
	\usebackgroundtemplate{
		\vbox to \paperheight{\vfil\hbox to \paperwidth{\hfil\includegraphics[width=\paperwidth]{humor/DonQuichotte.png}\hfil}\vfil}
	}
	\begin{frame}
		\frametitle{So, why support Workflow Management Systems?}
		\vspace*{-4mm}
		\begin{mdframed}[tikzsetting={draw=white,fill=white,fill opacity=0.8,
				line width=0pt},backgroundcolor=none,leftmargin=0,
			    rightmargin=150,innertopmargin=4pt,roundcorner=10pt]
			\begin{itemize}
                \item because you want to support good science!
				\item because you are loosing ground otherwise!
				\item because you want to support your users!
				\item because you want to lower your support load! (Workflow Management Systems help with I/O issues, software deployment, data management, etc.)
			\end{itemize}
		\end{mdframed}
		\vspace*{9em}
		\hfill{\bf \color{structure}sketch coal \& sanguine by C. Meesters - CC-BY-4.0}
	\end{frame}
}
