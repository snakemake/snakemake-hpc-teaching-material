...
\begin{frame}
	...
	\begin{figure}
		...
		\caption*{\textbf{>1.2e6} downloads since 2015\newline
			...
			various batch systems supported. SLURM plugin with \textbf{> 650.000} downloads since 2023\newline
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			General:
			\begin{itemize}
				\item caching of files to re-use
				\item internal support for scripts (R, Python, shell, $\ldots$)
				\item possible to update from a queue (e.\,g. experiment data live processing)
			\end{itemize}
		\end{column}
		\begin{column}{0.5\textwidth}
			Cluster specifics:
