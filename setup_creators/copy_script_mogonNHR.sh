...
CLUSTER_ALIAS="mogon-nhr" 
BASEPATH="/lustre/project/nhr-workflows/workflows" # repeated used
...
rsync -rtlv --chmod=D755 "solutions" "${CLUSTER_ALIAS}:/lustre/project/nhr-worfklows"
rsync -rtlv --chmod=D755 "mpi_example" "${CLUSTER_ALIAS}:/lustre/project/nhr-worfklows"
